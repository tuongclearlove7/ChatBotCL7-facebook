...
//import {model} from './html_model.js';
...
var model = {
    ...
    pagE2 : `
        ...
        pagE3 : `<div class="page3"><h1>Page3</h1></div>`,
...
function start(){
    ...
    renderShowInputBlock(model.block);
    renderShowPage();
    backToTop();
...
function backToTop(){
    ...
    getIDFooter.innerHTML = model.top;
...
function renderShowPage(){
    ...
    document.querySelector(listItem[4]).onclick = function(){
        ...
        changePage5(model.pagE5),scrollClick(0);
